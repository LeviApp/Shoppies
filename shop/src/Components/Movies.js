        ...
        return (
            <div className='moviesComp'>
              ...
              {props.movies.map((movie) => {
                  return <Movie movie={movie} nominated={props.nominated} key={movie.imdbID} ID={movie.imdbID + movie.Year} nominatedMovie={props.nominatedMovie} deleteNom={props.deleteNom} />
              })}
                </div>
            </div>
        )
